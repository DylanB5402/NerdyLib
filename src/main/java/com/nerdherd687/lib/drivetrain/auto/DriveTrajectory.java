...
import com.nerdherd687.lib.drivetrain.TrajectoryFollower;
...
public class DriveTrajectory extends Command {
  ...
  public DriveTrajectory(Drivetrain drive, Trajectory traj, int lookahead, Boolean goingForwards, double kP, double kD) {
    m_drive = drive;
